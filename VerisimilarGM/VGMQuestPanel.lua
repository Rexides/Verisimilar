...
function VerisimilarGM:InitializeQuestPanel()
	...
	local description={
						...
						{text="Objectives",showOnEnabled=false,showOnDisabled=true,
							...
							{type="EditBox", key="poiX",label="X:",x=25,y=-110,width=130,labelPosition="LEFT",setFunc=SetPoiCoords, getFunc=GetPoiX,tooltip="The X coordinates for the objective mark on the map"},
							{type="EditBox", key="poiY",label="Y:",refFrame="PREVIOUS",refPoint="TOPRIGHT",x=25,y=0,width=130,labelPosition="LEFT",setFunc=SetPoiCoords, getFunc=GetPoiY,tooltip="The Y coordinates for the objective mark on the map"},
