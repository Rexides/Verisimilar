...
function VerisimilarGM:InitializeQuestPanel()
	...
	local description={
						...
						{text="Completion",showOnEnabled=false,showOnDisabled=true,
							...
							{type="LargeEditBox", key="completionText",label="Completion text",x=330,y=-15,width=300,height=200,setFunc=function(editBox,text)VerisimilarGM:GetActiveElement():SetCompletionText(text);end, getFunc=function() return VerisimilarGM:GetActiveElement():GetCompletionText(); end,tooltip="This text will appear when the player is given the option to complete the quest"},
