...
function VerisimilarGM:InitializeNPCPanel()
	...
	local description={
						...
						{text="Location",showOnEnabled=false,showOnDisabled=true,
							...
							{type="EditBox", key="coordX",label="X:",x=25,y=-120,width=130,labelPosition="LEFT",setFunc=SetCoords, getFunc=GetX,tooltip="The X coordinates for the position of the NPC on the map"},
							{type="EditBox", key="coordY",label="Y:",refFrame="PREVIOUS",refPoint="TOPRIGHT",x=25,y=0,width=130,labelPosition="LEFT",setFunc=SetCoords, getFunc=GetY,tooltip="The Y coordinates for the position of the NPC on the map"},
