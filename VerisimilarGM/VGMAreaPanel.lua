...
function VerisimilarGM:InitializeAreaPanel()
	...
	local description={
						...
						{text="Regions",showOnEnabled=false,showOnDisabled=true,
							...
							{type="EditBox", key="regionX",label="X:",coordinates=true,refFrame="PREVIOUS",refPoint="TOPRIGHT",x=20,y=0,width=60,labelPosition="LEFT",setFunc=SetRegionCoords, getFunc=GetRegionX,tooltip="The x coordinate of the region's center point"},
							{type="EditBox", key="regionY",label="Y:",coordinates=true,refFrame="PREVIOUS",refPoint="TOPRIGHT",x=30,y=0,width=60,labelPosition="LEFT",setFunc=SetRegionCoords, getFunc=GetRegionY,tooltip="The y coordinate of the region's center point"},
							...
							{type="EditBox", key="regionWidth",label="Width:",coordinates=true,refFrame="regionType",refPoint="BOTTOMLEFT",x=0,y=-10,width=60,labelPosition="LEFT",setFunc=SetRegionWidth, getFunc=GetRegionWidth,tooltip="The region's radius (if circle) or width (if rectangle)"},
							...
							{type="EditBox", key="regionHeight",label="Height:",coordinates=true,refFrame="regionWidth",refPoint="BOTTOMLEFT",x=0,y=-5,width=60,labelPosition="LEFT",setFunc=SetRegionHeight, getFunc=GetRegionHeight,tooltip="The region's radius (if circle) or width (if rectangle)"},
							...
							{type="EditBox", key="regionThreshold",label="Threshold:",coordinates=true,refFrame="setWidthToPlayer",refPoint="TOPRIGHT",x=80,y=0,width=60,setFunc=SetRegionThreshold, getFunc=GetRegionThreshold,tooltip="The additional distance the player has to cover before entering or leaving the area"},
