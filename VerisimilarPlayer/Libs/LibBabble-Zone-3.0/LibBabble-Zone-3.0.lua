...
local MINOR_VERSION = 90000 + tonumber(("$Rev: 301 $"):match("%d+"))
...
elseif GAME_LOCALE == "esES" then
	...
	["The Bastion of Twilight"] = "El Baluarte de Crepúsculo - El Bastión del Crepúsculo",
	...
	["Throne of the Four Winds"] = "Trono de Cuatro Alas",
	["Throne of the Tides"] = "Trono de Tides",
	...
	["Twin Peaks"] = "Picos Gemelos - or femenin - Cumbres Gemelas",
